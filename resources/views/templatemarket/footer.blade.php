     ...
     <div class="container py-5">
         <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
             <div class="row g-4">
                 <div class="col-lg-3">
                     <a href="#">
                         <h1 class="text-primary mb-0">MarketPlace</h1>
                         <p class="text-secondary mb-0">Products Original</p>
                     </a>
                 </div>
                 <div class="col-lg-6">
                     <div class="position-relative mx-auto">
                         ...
                         <button type="submit"
                             ...
                             style="top: 0; right: 0;">Subscribe Sekarang</button>
                     </div>
                 </div>
                 <div class="col-lg-3">
         ...
         <div class="row g-5">
             <div class="col-lg-3 col-md-6">
                 <div class="footer-item">
                     ...
                     <p class="mb-4">Kualitas Product Kami Sangat Bagus Dan Harga Juga Tidak Mengecewakan.</p>
                     <a href="" class="btn border-secondary py-2 px-4 rounded-pill text-primary">Baca
                         Selengkapnya</a>
                 </div>
             </div>
             <div class="col-lg-3 col-md-6">
                 <div class="d-flex flex-column text-start footer-item">
                     ...
                     <a class="btn-link" href="">Pengembalian</a>
             ...
             <div class="col-lg-3 col-md-6">
                 <div class="d-flex flex-column text-start footer-item">
                     ...
                     <a class="btn-link" href="">Daftar</a>
                     <a class="btn-link" href="">Riwayat Pesanan</a>
                     <a class="btn-link" href="">Pesanan International</a>
                 </div>
             </div>
             <div class="col-lg-3 col-md-6">
                 <div class="footer-item">
                     <h4 class="text-light mb-3">Kontak</h4>
                     <p>Alamat: JL Ohara, No 48247</p>
                     <p>Email: marketPlace@gmail.com</p>
                     <p>Phone: +0123 4567 8910</p>
                     <p>Pembayaran Di Terima</p>
         ...
         <div class="row">
             <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                 <span class="text-light"><a href="#"><i
                             class="fas fa-copyright text-light me-2"></i>MarketPlace</a>, All right reserved.</span>
             </div>
             <div class="col-md-6 my-auto text-center text-md-end text-white">
                 Designed By <a class="border-bottom" href="#">HTML Codex</a> Distributed By <a
                     class="border-bottom" href="#">Nico</a>
             </div>
         </div>
     </div>
 </div>
